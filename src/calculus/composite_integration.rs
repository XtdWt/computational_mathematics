...
mod tests {
    ...
    fn integrate_simple_polynomial_n_one() {
        ...
        assert_almost_eq!(composite_trapezoid_rule(&f, a, b, 1), 24.0);
        assert_almost_eq!(composite_simpsons_rule(&f, a, b, 2), 24.0);
    }
    ...
    fn integrate_simple_polynomial() {
        ...
        assert_almost_eq!(
            composite_trapezoid_rule(&f, a, b, 100),
            expected_result
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 100),
            expected_result
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 101),
            expected_result
        );
    }
    ...
    fn integrate_polynomial_n_one() {
        ...
        assert_almost_eq!(composite_trapezoid_rule(&f, a, b, 1), 1866.0);
        assert_almost_eq!(composite_simpsons_rule(&f, a, b, 2), 958.125);
    }
    ...
    fn integrate_polynomial() {
        ...
        assert_almost_eq!(
            composite_trapezoid_rule(&f, a, b, 10_000),
            expected_result,
            1e-4
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 10_000),
            expected_result
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 10_001),
            expected_result
        );
    }
    ...
    fn integrate_sine_n_one() {
        ...
        assert_almost_eq!(
            composite_trapezoid_rule(&f, a, b, 1),
            1.5*((8.0_f64).sin() + (2.0_f64).sin())
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 2),
    ...
    fn integrate_exponential() {
        ...
        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 1_000),
            expected_result
        );

        assert_almost_eq!(
            composite_simpsons_rule(&f, a, b, 1_001),
            expected_result
        );
    }
}
